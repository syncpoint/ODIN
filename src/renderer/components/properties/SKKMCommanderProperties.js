...
const SKKMCommanderProperties = props => {
  ...
  return (
    <>
      ...
      <TextProperty label='Date-Time Group' property='w' properties={properties} onCommit={props.update}/>
...
SKKMCommanderProperties.propTypes = {
  getProperties: PropTypes.func.isRequired,
  update: PropTypes.func.isRequired
}

export default SKKMCommanderProperties
